      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-8rem)]">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight font-space-grotesk">
              <span className="block text-gray-900 mb-4 font-poppins">
              ...
              <span className="block text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-800 mb-4 font-space-grotesk">
            ...
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl font-inter">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl inline-flex items-center gap-3"
              >
                <Target size={24} />
                Start My Journey
              ...
              <button className="group bg-white/80 backdrop-blur-sm border-2 border-blue-200 hover:border-blue-400 text-blue-700 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-white inline-flex items-center gap-3">
                <Users size={24} />
                Join 50K+ Students
              </button>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20 max-w-lg w-full">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {careerPaths.map((career) => (
                    <button
                      ...
                      className={`group relative p-6 rounded-2xl transition-all duration-500 hover:scale-105 transform ${
                ...
                {selectedCareer && (
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-2xl animate-fade-in-up border border-blue-200">
